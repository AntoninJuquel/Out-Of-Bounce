...
{
    [CreateAssetMenu(fileName = "New laser platform upgrade", menuName = "Upgrades/LaserPlatform", order = 0)]
    public class LaserPlatformUpgrade : UpgradeSo
    {
        [SerializeField] private LayerMask whatIsDot;
        [SerializeField] private GameObject laserParticles;

        public override void TriggerUpgrade(GameObject gameObject)
        {
